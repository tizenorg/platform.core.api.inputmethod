 ...
 *
 * @details If the device_type parameter of the ime_process_input_device_event_cb() function indicates
 * the current input device type is IME_INPUT_DEVICE_TYPE_ROTARY, then the input_data parameter
 * should be cast into #ime_rotary_input_device_event_s type, as shown in the example code.
 *
 * @since_tizen 3.0
 *
 ...
 *
 * @code
 static void inputmethod_process_input_device_event_cb(ime_input_device_type_e device_type, void *input_data);
 {
