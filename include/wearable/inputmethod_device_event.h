 ...
 * @privilege %http://tizen.org/privilege/ime
 *
 * @param[in] ime_input_device_data_h The input device handle
 * @param[out] ime_input_device_rotary_direction_e The direction that the rotary input device was rotated to
 *
 * @return 0 on success, otherwise a negative error value
 * @retval #IME_ERROR_NONE No error
 * @retval #IME_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @endcode
 */
EXPORT_API int ime_input_device_rotary_get_direction(ime_input_device_event_h device_event, ime_input_device_rotary_direction_e *direction);

/**
 * @brief Gets the timestamp of the rotary input device event
 *
 * @since_tizen 3.0
 *
 * @privlevel public
 ...
 *
 * @param[in] ime_input_device_data_h The input device handle
 * @param[out] unsigned int The time indicating when the rotary input device was rotated
 *
 * @return 0 on success, otherwise a negative error value
 * @retval #IME_ERROR_NONE No error
 * @retval #IME_ERROR_INVALID_PARAMETER Invalid parameter
 ...
 * @see ime_process_input_device_event_cb()
 */
EXPORT_API int ime_input_device_rotary_get_timestamp(ime_input_device_event_h device_event, unsigned int *timestamp);
