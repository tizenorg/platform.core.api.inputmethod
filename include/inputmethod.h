 ...
 * The @a input_data parameter needs to be cast into an appropriate event structure pointer type.
 * Refer to inputmethod_evtdef.h for the list of event structures for each unconventional input devices.
 *
 ...
 * @see ime_event_set_process_input_device_event_cb()
 */
typedef void(*ime_process_input_device_event_cb)(ime_input_device_type_e device_type, void *input_data, void *user_data);
 ...
 * @code
 ...
 static void inputmethod_process_input_device_event_cb(ime_input_device_type_e device_type, void *input_data, void *user_data);
 {
