 ...
 * @since_tizen 3.0
 *
 * @see ime_event_set_process_unconventional_input_device_event_cb
 */
typedef enum {
    IME_UNCONVENTIONAL_INPUT_DEVICE_TYPE_NONE, /**< Undefined unconventional input device */
    IME_UNCONVENTIONAL_INPUT_DEVICE_TYPE_ROTARY,
} ime_unconventional_input_device_type_e;
 ...
 *
 * @remarks @a dev_type contains the information what kind of unconventional input device generated the given event,
 ...
 *
 * @param[in] dev_type The unconventional input device type
 * @param[in] input_data The dev_type specific input data
 *
 * @return @c true if the event is processed properly.
 *
 * @pre The callback can be registered using ime_event_set_unconventional_input_device_event_cb() function.
 *
 * @see ime_event_set_process_unconventional_input_device_event_cb
 */
typedef bool(*ime_process_unconventional_input_device_event_cb)(ime_unconventional_input_device_type_e dev_type, void *input_data);
...
/**
 * @brief Sets @c process_unconventional_input_device_event event callback function.
 *
 * @remarks The ime_process_unconventional_input_device_event_cb() callback function is called when the event
 ...
 * @post The ime_run() function should be called to start to run IME application's main loop.
 *
 * @see ime_process_unconventional_input_device_event_cb, ime_run
 *
 * @code
 static void inputmethod_create_cb(void *user_data);
 static void inputmethod_terminate_cb(void *user_data);
 ...
 void ime_app_main(int argc, char **argv)
 {
    ...
    ime_event_set_unconventional_input_device_event_cb(inputmethod_process_unconventional_input_device_event_cb, NULL);

    ime_run(&basic_callback, NULL);
 }
 * @endcode
 */
EXPORT_API int ime_event_set_process_unconventional_input_device_event_cb(ime_process_unconventional_input_device_event_cb callback_func);
