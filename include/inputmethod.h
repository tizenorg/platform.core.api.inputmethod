 ...
 * @see ime_event_set_process_input_device_event_cb
 */
typedef bool(*ime_process_input_device_event_cb)(ime_input_device_type_e dev_type, void *input_data, void *user_data);
 ...
 * @code
 ...
 static bool inputmethod_process_input_device_event_cb(ime_input_device_type_e dev_type, void *input_data, void *user_data);
 {
 ...
 void ime_app_main(int argc, char **argv)
 {
    ...
    ime_event_set_input_device_event_cb(inputmethod_process_input_device_event_cb, NULL);
